#pragma once
//Added the alignas(32) directive, which helps improve memory alignment, resulting in better performance when optimizing with SIMD instructions
#include <vector>
#include <iostream>
#include "vec4.h"
#include "matrix.h"
...
struct alignas(32) Vertex {       //32byte alignment helps to use SIMD instructions for efficient operations.
...
class alignas(32) Mesh {   //Ensure that Mesh objects are 32byte aligned in memory
public:
